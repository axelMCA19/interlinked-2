...
<head>
	...
	<title>Interconectados PF</title>
		...
		<header id="header">
			<div class="container">
				<div class="holder center-block">
					<!-- Logo of the page -->
    				<!--bueno no se en que idioma esta miteclado a blueto xd solo se que no se espera ya lo investigue esta en español ya qu ecomo puedo ver se puede poner la ñ-->
					<div class="logo">
						<a href="#">
							<img src="../../images/LOGO-WHITE-INK.svg" alt="interlinked" class="light img-responsive width">
							<img src="../../images/LOGO-INK-DARK.svg" alt="interlinked" class="dark img-responsive width">
						</a>
					</div>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="registroPS/registro.php" >
								...
								<li><a href="registroA/registro.php" >
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses-fill" viewBox="0 0 16 16">
										<path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.5 2.5 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354z"/>
										<path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708z"/>
									  </svg>
								...
								<li><a href="documentacionPF/index.php" >
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses-fill" viewBox="0 0 16 16">
										<path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.5 2.5 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354z"/>
										<path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708z"/>
									  </svg>
								...
								<li><a href="ListasAF/index.php" >
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-person" viewBox="0 0 16 16">
										<path d="M12 1a1 1 0 0 1 1 1v10.755S12 11 8 11s-5 1.755-5 1.755V2a1 1 0 0 1 1-1zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
										<path d="M8 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
									  </svg>
									  <strong><?php echo  $_SESSION['ciudad'];?></strong>
								</a></li>
								<li><a href="ListasPS/index.php" >
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-person" viewBox="0 0 16 16">
										<path d="M12 1a1 1 0 0 1 1 1v10.755S12 11 8 11s-5 1.755-5 1.755V2a1 1 0 0 1 1-1zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
										<path d="M8 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
									  </svg>
									  <strong>PRESIDENTES</strong>
								</a></li>
				...
				<div class="container">
					<div class="row">
						<header class="heading-holder col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
							<br>
							<h1>Panel "P.F" <?php echo $_SESSION['usuario_nombre']; ?></h1>
							<p>
								Bienvenido sr <strong><?php echo $_SESSION['usuario_nombre'] . ' ' . $_SESSION['usuario_apellido']; ?></strong>, panel de ("Presidente de Federación"), aqui podras administrar los datos de tu ciudad "<strong><?php echo  $_SESSION['ciudad'];?></strong>" y mantener un control de todos tus presidentes y afiliados de tu <strong><?php echo $_SESSION['federacion'];?></strong>.
						    </p>
						</header>
					</div>
			...
			<section class="features-area container" data-scroll-index="1">
				<div class="row">
					<header class="col-xs-12 heading-wrap col-sm-6 col-sm-offset-3 text-center">
						<h2><strong>PRESIDENTE DE FEDERACIÓN</strong></h2>
					</header>
				</div>
				...
				<ul class="features-list">
					...
					<li>
						...
						<h3>CIUDAD:</h3>
						<p><strong><?php echo $_SESSION['ciudad'];?></strong></p>
					...
					<li>
						...
						<p>CI:"<strong><?php  echo  $_SESSION['carnet'];?></strong>"</p>
					...
					<li>
						...
						<p>Presidente N° "<strong><?php echo   $_SESSION['numeroPF'];?></strong>" de la ciudad de "<strong><?php echo   $_SESSION['ciudad'];?></strong>"</p>
					...
					<li>
						...
						<h3>CODIGO DE PRESIDENTE FEDERACIÓN:</h3>
						<P><strong><?php echo $_SESSION['codigoPF'];?></strong></P>
					...
					<li>
						...
						<h3>GENERO:</h3>
						<p>Genero: <strong><?php  echo   $_SESSION['generos'];?></strong></p>
					</li>
					<li>
						<div class="icon-holder">
						</div>
						<h3>Federación:</h3>
						<p>: <strong><?php echo $_SESSION['federacion'];?></strong> de la ciudad de, <strong><?php echo $_SESSION['ciudad'];?></strong></p>
					</li>
				</ul>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-center col-sm-6 col-sm-offset-3">
							<div class="logo"><a href="#"><img src="../../images/LOGO-WHITE-INK.svg" alt="Inteconectados"></a></div>
