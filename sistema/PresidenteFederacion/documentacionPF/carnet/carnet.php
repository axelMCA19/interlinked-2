...
<html lang="en">
    <head>
        <title>Carnet presidente federación</title>
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta
            name="viewport"
    ...
    <!-- Resto del formulario aquí -->
                ...
                <div class="card">
                            <div class="card-header"><strong><h1 style="text-align: center;">FORMULARIO DE OBTENCIÓN DE CARNET</h1></strong></div>
                            <div class="card-body">
                                <form action="ejemplo.php" id="formularios" method="post">
                                    ...
                                    <div class="col">
                                        ...
                                        <input
                                            ...
                                            name="codigoPF"
                                            id="codigoPF"
                                            value="<?php echo $_SESSION['codigoPF']; ?>"
                                            readonly
