...
<html lang="en">
    <head>
        ...
        />
        <link rel="stylesheet" href="credencial.css">
    ...
    <!-- Resto del formulario aquí -->
                ...
                <div class="card">
                            <div class="card-header"><strong><h1 style="text-align: center;">FORMULARIO DE OBTENCIÓN DE CREDENCIAL</h1></strong></div>
                            <div class="card-body">
                                <form action="ejemplo.php" id="formularios" method="post">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <input
                                            ...
                                            name="numeroPF"
                                            id="numeroPF"
                                            value="<?php echo $_SESSION['numeroPF']; ?>"
                                            readonly
                                        />
                                        </div>
                                        <div class="col">
                                   ...
                                   <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        />
                                            ...
                                            <div class="mb-3">
                                                <label for="" class="form-label"><strong>Fecha de solicitud de certificado:</strong></label>
                                                <input
                                                    type="text"
                                                    class="form-control"
                                                    name="solicitud"
                                    ...
                                    <button type="submit" id="registrarme" class="btn btn-success">
                                        ...
                                        </svg>obtener credencial
                                    </button>
                                    <a href="../index.php" id="iniciar" class="btn btn-secondary" >
            ...
            document.addEventListener('DOMContentLoaded', function(){
                ...
                document.getElementById("formularios").addEventListener('submit', function(event){
                   ...
                   if (password !== confirmarContraseña) {
                        ...
                        event.preventDefault();//detenemos el envio del form
