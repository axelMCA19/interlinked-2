				...
				<div class="container">
					<div class="row">
						<header class="heading-holder col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
							...
							<p><strong>Contrato AS</strong>: <a style="color: white;" href="contratoAdquisicionServicio/contrato-p-s.php">Clic aqui para obtener tu contrato de prestación de </a></p>
						</header>
					</div>
