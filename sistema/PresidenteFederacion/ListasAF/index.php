...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
    ...
    foreach ($_POST['id'] as $key => $id) {
        ...
        // Query SQL para actualizar los datos en la tabla 'usuarios'
        $update_sql = "UPDATE usuarios SET nombres='$nombres', apellidos='$apellidos', carnet='$carnet', sindicato='$sindicato' WHERE id='$id'";
...
echo "<p>Aquí podrás gestionar los datos de todos tus afiliados de tu " . htmlspecialchars($_SESSION['federacion']) . " de " . htmlspecialchars($_SESSION['ciudad']) . ".</p>";
...
while ($row = $result_all->fetch_assoc()) {
    echo "<tr>
            ...
            <td><input type='text' value='" . htmlspecialchars($row['codigoA']) . "' name='codigoA[]' readonly></td>
            ...
            <td><input type='text' value='" . htmlspecialchars($row['numeroA']) . "' name='numeroA[]' readonly></td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        Array.from(userTableBody.rows).forEach(function(row) {
        ...
        var visibleRows = Array.from(userTableBody.rows).filter(function(row) {
