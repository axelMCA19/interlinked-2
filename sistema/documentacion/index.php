				...
				<div class="container">
					<div class="row">
						<header class="heading-holder col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
							...
							<p style="font-weight: 800;"><strong>Contrato</strong>: <a style="color: white;" href="contratoAdquisicionServicio/contrato-p-s.php">Contrato de adquisicion de servicios</a></p>
						</header>
					</div>
