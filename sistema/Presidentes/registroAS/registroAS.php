...
<html lang="en">
<head>
    <title>Registro afiliado sindicato</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="registroAS.css">
                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <?php if (isset($successes) && $successes) { ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <strong>¡Afiliado registrado correctamente!</strong> Felicidades has registrado a un nuevo afiliado a tu sindicato <?php echo $_SESSION['sindicato'];?>! clic 
                            <a
                                name=""
                                id=""
                                class="btn btn-primary"
                                href="../afiliadosSindicato/index.php"
                                role="button"
                                >aqui</a
                            >
                            para poder ver tus registros
                        </div>
                    <?php } elseif (isset($successes) && !$successes) { ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            <strong>¡El registro falló! debido a que intentas registrar un codigo ya usado o no disponible o a que ya tienes registro revisa tus datos o comunicate con el presidente de tu federación</strong> <?php echo isset($error_message) ? $error_message : ''; ?>
                        </div>
                    <?php } ?>
                    
                    <!-- Formulario de registro -->
                    <div class="card">
                        <div class="card-header"><h3 style="text-align: center;"><strong>Formulario de afiliación a <?php echo $_SESSION['sindicato'];?></strong></h3></div>
                        <p class="parrafo">Bienvenido sr presidente <?php echo $_SESSION['usuario_nombre'];?> aqui podra afiliar a tus miembros</p>
                        <div class="card-body">
                            <form action="registroAS.php" id="formularios" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <small style="color: white;"><?php echo $_SESSION['sindicato'];?> recuerda!</small>
                                        <input type="text" class="form-control" name="sindicato" id="sindicato" oninput="this.value = this.value.toUpperCase()" placeholder="Sindicato"  />
                                    </div>
                                </div>
