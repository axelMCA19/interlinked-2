...
<head>
    ...
    <link rel="stylesheet" href="registroPresidente.css">
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header"><h3 style="text-align: center;"><strong>Formulario de registro de Presidente</strong></h3></div>
                        <div class="card-body">
                            <form action="registro.php" id="formularios" method="post">
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        <label for="" class="form-label"><strong>N° de presidente</strong></label>
                                        <input
                                            type="Text"
                                            class="form-control"
                                            name="numeroA"
