...
<html lang="en">
    <head>
        <title>Contrato de prestacion de servicios</title>
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta
            name="viewport"
    ...
    <!-- Resto del formulario aquí -->
                ...
                <div class="card">
                            <div class="card-header"><strong><h1 style="text-align: center;">Formulario datos de para obtener tu contrato de adquisición de servicios</h1></strong></div>
                            <div class="card-body">
                            ...
                            <div class="card-footer text-muted"><p class="interlineado" style="text-align: center; color:aliceblue;">Interconectados</p></div>
                        </div>
