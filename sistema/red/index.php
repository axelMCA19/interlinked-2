    ...
    <header class="fixed-top">
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <!-- menu -->
                <div class="col-12 col-lg-6 menu col-xl-6 d-flex text-center order-3 order-lg-2 justify-content-center">
                    <a href="" class="active">
                ...
                <!-- botones -->
                <nav class="col-auto botones col-lg-3 col-xl-2 text-end d-flex align-items-center justify-content-end order-2 order-lg-3">
                    <a href="" class="perfil">
                        <img src="img/yo12.jpg" alt="">Héctor
                    </a>
                    <a href="">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center justify-content-lg-between ">
            ...
            <aside class="enlaces-rapidos col-3 col-xl-2">
                <nav>
                    <a href="" class="perfil">
                        <img src="./img/yo12.jpg" alt="">Hector Allende
                    </a>
            ...
            <main class="col-12 col-sm-10 col-md-6 col-xxl-4">
                ...
                <div class="publicar">
                    ...
                    <div class="formulario d-flex justify-self-auto">
                        <a href="" class="foto">
                            <img src="img/yo12.jpg" alt="">
                        </a>
                ...
                <div class="publicaciones">
                    <div class="publicacion">
                        ...
                        <div class="header">
                            ...
                            <div class="datos">
                                <a href="" class="nombre">Juan Gonzalez</a>
                                <a href="" class="hora">1 hr</a>
                            </div>

                        </div>

                        <div class="body">
                            <p>Disfrutando el paisaje :)..</p>
                ...
                <div class="publicaciones">
                    <div class="publicacion">
                        ...
                        <div class="header">
                            ...
                            <div class="datos">
                                <a href="" class="nombre">Damian Corradini</a>
                                <a href="" class="hora">1 hr</a>
                            </div>
                ...
                <div class="publicaciones">
                    <div class="publicacion">
                        ...
                        <div class="header">
                            ...
                            <div class="datos">
                                <a href="" class="nombre">Eugenia Allende</a>
                                <a href="" class="hora">24 hr</a>
                            </div>
            ...
            <aside class="contactos col-3 col-xl-2">
                ...
                <div class="seccion">
                    ...
                    <nav>
                        <a href="" class="perfil">
                            <img src="img/persona1.jpg" alt="">Juan Gonzalez
                        </a>
                    </nav>
                    <nav>
                        <a href="" class="perfil">
                            <img src="img/persona2.jpg" alt="">Dami Corradini
                        </a>
                    </nav>
                    <nav>
                        <a href="" class="perfil">
                            <img src="img/persona3.jpg" alt="">Ceci Carrizo
                        </a>
                    </nav>
                    <nav>
                        <a href="" class="perfil">
                            <img src="img/persona4.jpg" alt="">Euge Allende
                        </a>
                    </nav>
